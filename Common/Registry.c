/*
 Copyright (c) 2004-2010 YourProduct Developers Association. All rights reserved.
...
void GetStartupRegKeyName (char *regk)
{
	...
	// YourProduct.exe to contain a possible Trojan horse because of this string (heuristic scan).

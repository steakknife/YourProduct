...
/* Volume header v5 structure (used since YourProduct 7.0): */
//
...
/* Deprecated/legacy volume header v4 structure (used by YourProduct 6.x): */
//
// Offset	Length	Description
// ------------------------------------------
// Unencrypted:
...
/* Deprecated/legacy volume header v3 structure (used by YourProduct 5.x): */
//
// Offset	Length	Description
// ------------------------------------------
// Unencrypted:
...
/* Deprecated/legacy volume header v2 structure (used before YourProduct 5.0): */
//
// Offset	Length	Description
// ------------------------------------------
// Unencrypted:
		   ...
		   unsigned __int64 encryptedAreaStart, unsigned __int64 encryptedAreaLength, uint16 requiredProgramVersion, uint32 headerFlags, uint32 sectorSize, BOOL bWipeMode)
{
	...
	{
		// We have no master key data (creating a new volume) so we'll use the YourProduct RNG to generate them
